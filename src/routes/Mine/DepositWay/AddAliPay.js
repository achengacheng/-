...
const Alipay = ({dispatch,getUserData}) => {
	...
	class Alipay extends React.Component{
		...
		render () {
			return (
				<div>
                    <Header head_title='绑定支付宝' left_show='1'/>
					<ChaPop HintWords={HintWords}/>
                    <div className={styles.AlipayWrap}>
						<div className={styles.AlipayBox}>
							<p>
								<span>真实姓名</span>
								<input type="text"  placeholder="请输入您的支付宝真实姓名" ref='cartName'/>
							</p>
							<p>
								<span>支付宝账号</span>
								<input type="text"  placeholder="请输入您的支付宝账号" ref='cardNO'/>
							</p>
						</div>
